      ...
      <div className="container ">
        <ol className="relative border-s border-gray-200 dark:border-gray-700">
          ...
          <li className="mb-10 ms-4">
            ...
            <h3 className="text-lg font-semibold">
              WebOps Team Manager - Inter IIT Tech Meet 12.0
            </h3>
            <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
              Co-developed the portal for the Inter IIT Tech Meet hosted by IIT
              Madras, facilitating the participation of 23 IITs.
            </p>
          </li>
          <li className="mb-10 ms-4">
            <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
          ...
          <li className="ms-4">
            ...
            <h3 className="text-lg font-semibold">
              Student Developer - InstiSpace
            </h3>
            <p className="text-base font-normal text-gray-500 dark:text-gray-400">
              Collaborated in the development of InstiSpace, a mobile
              application for the students of IIT Madras.
            </p>
          </li>
        </ol>
      </div>
